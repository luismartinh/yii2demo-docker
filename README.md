<p align="center">
    ...
    <h1 align="center">App Yii2 demo con docker compose</h1>
    <br>
</p>


El propósito de este proyecto es poder ejecutar una aplicación desarrollada con el Framework Yii2 basado en PHP en contenedores docker:

El objetivo es poder suplantar con los contenedores docker los servicios necesarios para recrear el entorno de ejecución, sin tener que instalarlos en el sistema anfitrión:

De esta manera, permitiría en el ciclo de desarrollo la ejecución de la app dentro de los contenedores.
...
docker exec yii2demo_db_1 mysql -uroot -ppepe prueba < db/backupprueba.sql
...
docker exec yii2demo_db_1  /usr/bin/mysqldump -u root --password=pepe --all-databases > db/backupprueba.sql
